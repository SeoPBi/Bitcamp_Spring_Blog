...
public class BlogServiceImpl implements BlogService {
    ...
    @Override
    public Page<Blog> findAll(Integer pageNum) { // 페이지 정보를 함께 포함하고 있는 리스트인 page를 리턴해야함
    ...
    public Blog findById(long blogId) {
        ...
        // JPA는 Optional을 쓰도록 권장하기 위해 리턴 자료형으로 강제해두었습니다.
...
//        blogRepository.save(blog);
    ...
    public void update(Blog blog) {
        ...
        Blog updatedBlog = blogJPARepository.findById(blog.getBlogId()).get(); // 준영속
