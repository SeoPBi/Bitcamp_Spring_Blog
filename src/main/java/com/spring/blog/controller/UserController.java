...
public class UserController {
    ...
    private final BCryptPasswordEncoder bCryptPasswordEncoder; // 암호 구문 비교를 위해서 추가
    ...
    // 주소는 localhost:8080/user/register 입니다.
    // 커맨드객체로 User Entity를 선언해서, 가입정보를 받아 .save()를 호출해주시면 됩니다.
    // 실행 결과는 리다이렉트로 /login으로 돌아가게 해주세요.
